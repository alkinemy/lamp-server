...
import lamp.collector.common.service.*;
...
public class MonitoringConfig {
	...
	public static class MonitoringHealthAppConfig implements SchedulingConfigurer {
		...
		@Bean
		public HealthMonitoringScheduledService appHealthMonitoringAppScheduledService() {
			return new HealthMonitoringScheduledService();
		}
	...
	public static class MonitoringMetricsAppConfig implements SchedulingConfigurer {
		...
		@Bean
		public MetricsMonitoringScheduledService appMetricsMonitoringAppScheduledService() {
			return new MetricsMonitoringScheduledService();
		}
