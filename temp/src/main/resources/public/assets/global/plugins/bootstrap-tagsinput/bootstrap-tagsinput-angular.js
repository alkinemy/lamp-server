  ...
  return {
    ...
    link: function(scope, element, attrs) {
      $(function() {
        ...
        // create a shallow copy of domain's current state, needed to determine
        // diff when domain changes
        ...
        scope.$watch("model", function() {
          ...
          // Remove tags no longer in binded domain
          ...
          // Add new items in domain as tags
