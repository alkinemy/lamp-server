...
JARFile="lamp-admin.jar"
PIDFile="lamp-admin.pid"
JVM_OPTS="-Xms256m -Xmx2048m"
SPRING_OPTS="--spring.config.name=lamp-admin"
...
case "$1" in
  ...
  start)
    ...
    nohup java $JVM_OPTS -jar $JARFile $SPRING_OPTS 1>out.log 2>error.log &
