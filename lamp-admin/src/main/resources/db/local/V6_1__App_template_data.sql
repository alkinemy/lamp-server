...
INSERT INTO `lamp_app_template` (`id`, `resource_type`, `name`, `description`, `repository_id`, `group_id`, `artifact_id`, `artifact_name`, `version`, `resource_url`, `process_type`, `pid_file`, `start_command_line`, `stop_command_line`, `pre_installed`, `app_filename`, `monitor`, `commands`, `deleted`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`)
VALUES
