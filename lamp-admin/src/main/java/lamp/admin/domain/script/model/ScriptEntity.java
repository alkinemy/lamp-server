...
public class ScriptEntity extends AbstractAuditingEntity {
	...
	private List<ScriptCommandEntity> commands = new ArrayList<>();

	@Transient
	public void addCommand(ScriptCommandEntity command) {
