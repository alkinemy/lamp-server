...
import lamp.admin.domain.app.repo.model.form.AppRepoCreateForm;
import lamp.admin.domain.app.repo.model.form.AppRepoUpdateForm;
import lamp.admin.domain.app.repo.repository.AppRepoEntityRepository;
...
@Service
public class AppRepoEntityService {
