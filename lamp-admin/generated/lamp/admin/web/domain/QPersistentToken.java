...
public class QPersistentToken extends EntityPathBase<PersistentToken> {
    ...
    private static final long serialVersionUID = -808674425L;
    ...
    public final DateTimePath<java.time.LocalDateTime> tokenDate = createDateTime("tokenDate", java.time.LocalDateTime.class);
