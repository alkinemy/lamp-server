...
import lamp.server.aladin.admin.repository.PersistentTokenRepository;
...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
    ...
    public CustomPersistentRememberMeServices(String key, org.springframework.security.core.userdetails
