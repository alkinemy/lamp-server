...
import lamp.server.aladin.api.ApiErrorCode;
import lamp.server.aladin.api.exception.ApiError;
...
public class JwtParser {
	...
	public JwtObject parse(String tokenString) {
		...
		try {
			...
			throw Exceptions.newException(ApiErrorCode.INVALID_AUTH_TOKEN, e);
		}
	}
}
