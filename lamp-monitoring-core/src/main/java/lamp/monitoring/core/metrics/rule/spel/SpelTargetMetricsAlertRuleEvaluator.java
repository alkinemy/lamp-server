...
import lamp.monitoring.core.base.alert.model.AlertState;
...
public class SpelTargetMetricsAlertRuleEvaluator implements AlertRuleEvaluator<SpelTargetMetricsAlertRule, MonitoringTargetMetrics> {
	...
	protected boolean isAlert(String ruleExpression, MonitoringTargetMetrics context) {
	...
	protected String getValue(String valueExpression, MonitoringTargetMetrics context) {
