...
@Getter
@Setter
@ConfigurationProperties(prefix = "collector", ignoreUnknownFields = false)
public class CollectorProperties implements ApplicationListener<ApplicationEvent> {
	...
	public void init() throws UnknownHostException {
		...
		if (StringUtils.isBlank(version)) {
			version = CollectorProperties.class.getPackage().getImplementationVersion();
		}
	}
