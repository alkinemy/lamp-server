...
@Slf4j
public class HealthRestTemplateCollector implements HealthCollector {
	...
	public TargetHealth getHealth(CollectionTarget collectionTarget) {
		...
		TargetHealth health = TargetHealth.of(timestamp, collectionTarget.getId(), collectionTarget.getName(), healthMap, tags);
