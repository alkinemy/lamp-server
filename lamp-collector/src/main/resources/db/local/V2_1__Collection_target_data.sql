...
VALUES
	('test', '테스트', 'localhost', '127.0.01', NULL, NULL, NULL, NULL, 1, 'SpringBoot', 'http://localhost:9010/health', 1, 'SpringBoot', 'http://localhost:9010/metrics', 'admin', NULL, 'admin', NULL);
