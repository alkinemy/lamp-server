...
import lamp.watcher.monitoring.collection.service.MonitoringMetricsService;
...
//		Collection<AlarmDefinition> monitoringTargets = monitoringTargetService.getMonitoringTargetsForMetricsCollection();
