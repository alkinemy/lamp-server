...
import lamp.monitoring.core.base.alert.model.AlertStateCode;
import lamp.monitoring.core.base.alert.model.event.AlertEvent;
...
import lamp.monitoring.core.metrics.kairosdb.model.KairosdbAlertRuleExpression;
import lamp.monitoring.core.metrics.kairosdb.model.KairosdbMetricsAlertRule;
...
public class KairosdbMetricsMonitoringWatcher {
	...
	public KairosdbMetricsMonitoringWatcher(SpelTargetMetricsAlertRuleProvider metricsAlertRuleProvider,
