...
@Slf4j
public class KafkaTargetMetricsExporter extends AbstractTargetMetricsExporter implements Closeable {

	private Producer<String, TargetMetrics> producer;
	private String topic;

	public KafkaTargetMetricsExporter(KafkaProducerProperties kafkaProperties) {
